...
You can run it using the link attached I am using github pages to host it and it is my first ever website.

This is my first time submitting a project in hackclub and i spent a lot of hours on this far more than my usual attention span for sure.

It has 4 editors that are displayed on the homepage Cuboid, Sphere, Pyramid and Custom each editor has the ability to scale it using sliders maximum usually 5-10cm and 
you can also pick the color using the color picker.In the custom editor however you can pick the mass and the various different shapes showed in the list and 
I didnt even know half those shapes existed before I searched up cool 3d shapes(i know its not the best search prompt).

There are 2 simulators the flaot page which shows whether your object sinks or floats and you can change the density using the slider top left and 
